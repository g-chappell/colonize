...
- **STORY-09** — Map data model
  ...
  - :white_check_mark: **TASK-017** — Tile type enum + Map model in packages/core  `high` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/22)  
    ...
    > serialization.
  - :white_check_mark: **TASK-018** — Procedural map generator  `high` `large` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/24)  
...
- **STORY-10** — Map rendering
  ...
  > targets.
  - :white_check_mark: **TASK-019** — Phaser GameScene + tile renderer  `high` `large` _(web, core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/25)  
...
- **STORY-13** — Turn loop
  ...
  - :white_check_mark: **TASK-024** — Turn state machine in packages/core  `high` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/34)  
    ...
    > transitions.
  - :white_check_mark: **TASK-025** — End-turn button wiring + year display  `high` `small` _(web, core)_ · [PR](https://github.com/g-chappell/colonize/pull/35)  
...
- **STORY-15** — Pathfinding + sailing rules
  ...
  - :white_check_mark: **TASK-029** — Wind / current zones  `med` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/49)  
...
- **STORY-17** — Rumour-tile mechanic
  ...
  - :white_check_mark: **TASK-032** — Rumour-tile entity in core + generator integration  `high` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/43)  
...
- **STORY-19** — Legendary shipwrecks → blueprint unlocks
  ...
  > payout instead.
  - :white_check_mark: **TASK-035** — Legendary Ship blueprint system  `med` `medium` _(core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/52)  
...
- **STORY-24** — Resource chains
  ...
  - :white_check_mark: **TASK-044** — Resource types + chain definitions  `high` `medium` _(core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/59)  
...
- **STORY-28** — Automated merchant routes
  ...
  > told to stop.
  - :white_check_mark: **TASK-050** — Merchant route data model + turn executor  `med` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/87)  
...
- **STORY-31** — Ground combat on islands
  ...
  - :white_check_mark: **TASK-055** — Ground unit types + ground-combat resolver  `high` `medium` _(core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/68)  
    _depends on: TASK-053_
...
- **STORY-33** — Fortifications
  ...
  - :white_check_mark: **TASK-057** — Fortification buildings + combat modifiers  `med` `medium` _(core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/93)  
...
- **STORY-34** — Rival diplomacy
  ...
  - :white_check_mark: **TASK-058** — Diplomacy actions + relations matrix  `high` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/69)  
    ...
    > AI's accept/decline.
  - :white_check_mark: **TASK-059** — Diplomacy screen (React)  `high` `medium` _(web)_ · [PR](https://github.com/g-chappell/colonize/pull/70)  
...
- **STORY-36** — NPC encounter factions
  ...
  - :white_check_mark: **TASK-062** — Tortuga black-market vendor UI  `med` `small` _(web, content)_ · [PR](https://github.com/g-chappell/colonize/pull/102)  
...
- **STORY-37** — Faction-unique bonuses
  ...
  - :white_check_mark: **TASK-063** — Implement per-faction bonus hooks  `high` `medium` _(core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/71)  
...
- **STORY-38** — Liberty Chimes → Archive Charters
  ...
  - :white_check_mark: **TASK-066** — Archive Charter pool + pick-2 UI  `high` `medium` _(web, core, content)_ · [PR](https://github.com/g-chappell/colonize/pull/74)  
...
- **STORY-39** — Concord tithes
  ...
  - :white_check_mark: **TASK-067** — Tithe calculator + tension meter  `high` `medium` _(core)_ · [PR](https://github.com/g-chappell/colonize/pull/75)  
    ...
    > ultimatum.
  - :white_check_mark: **TASK-068** — Tithe notification + payment UI  `med` `small` _(web, content)_ · [PR](https://github.com/g-chappell/colonize/pull/103)  
...
- **STORY-41** — Declaration of Sovereignty + Concord Fleet
  ...
  - :white_check_mark: **TASK-071** — Sovereignty War UI overlay + progress tracker  `high` `medium` _(web)_ · [PR](https://github.com/g-chappell/colonize/pull/77)  
...
- **STORY-42** — Victory & loss conditions
  ...
  - :large_orange_diamond: **TASK-073** — Balance pass: tune thresholds for all 4 victory paths  `med` `medium` _(core, content)_  
